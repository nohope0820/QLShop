...
<input onclick="history.go(-1);" type="button" value="Quay lại" class="btn btn-primary" style="background-color: green; margin-bottom: 15px;">	
    <div class="panel panel-primary" style="border-color: green;">
        ...
        <form method="post" enctype="multipart/form-data" action="{{ route('product.update', ['id' => $record->id]) }}">
            ...
            <div class="row" style="margin-top:15px;">
                ...
                <div class="col-md-10">
                    <input type="number" style="border-color: green;" value="{{ isset($record->price) ? $record->price:'' }}" min="0" step="0.01" name="price" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
            <div class="row" style="margin-top:15px;">
                ...
                <div class="col-md-10">
                    <input type="number" style="border-color: green;" value="{{ isset($record->discount) ? $record->discount:'' }}" name="discount" class="form-control" min="0" max="100" required>
                </div>
            </div>
            <!-- end rows -->
             <!-- rows -->
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    @if($record->image != "" && file_exists("images/product/".$record->image))
