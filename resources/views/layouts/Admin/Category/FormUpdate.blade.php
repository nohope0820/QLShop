...
<input onclick="history.go(-1);" type="button" value="Quay lại" class="btn btn-primary" style="background-color: green; margin-bottom: 15px;">	
    <div class="panel panel-primary" style="border-color: green;">
        ...
        <form method="POST" action="{{ route('category.update', ['id' => $rows->id]) }}">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="{{ isset($rows->name) ? $rows->name:'' }}" name="name" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->
             <!-- rows -->
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <textarea name="description">{{ isset($rows->description) ? $rows->description:'' }}</textarea>
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    @if(isset($rows->image) && $rows->image != "" && file_exists("images/".$rows->image))
