...
<div class="col-md-12">
   ...
   <style>
    ...
    <form method="POST" action="{{ route('timekeeping.checkByName') }}">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <b style="color: black; text-decoration:underline">Nhập tên:</b> 
    
            <select name="MaNV" style="padding: 2px 20px">
    ...
    <div class="panel panel-primary" style="border-color: green; margin-top:25px">
        <div class="panel-heading" style="text-decoration: underline;font-size:16px;font-family: times new roman;">Kiểm tra chấm công theo tên</div>
        <style>
            .panel-heading{
